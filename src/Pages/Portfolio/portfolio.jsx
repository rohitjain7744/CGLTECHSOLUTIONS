...
══════════════════════════════════════ */
const PROJECTS = [
  { id: 1,  type: "image", src: img1,  cat: "logo",  tag: "CGL TECH SOLUTIONS"   },
  { id: 2,  type: "image", src: img2,  cat: "logo",       tag: "CGL TECH SOLUTIONS"    },
  { id: 3,  type: "image", src: img3,  cat: "logo",       tag: "CGL TECH SOLUTIONS"     },
  { id: 4,  type: "image", src: img4,  cat: "logo",       tag: "CGL TECH SOLUTIONS"        },
  { id: 5,  type: "image", src: img5,  cat: "logo",       tag: "CGL TECH SOLUTIONS"    },
  { id: 6,  type: "image", src: img6,  cat: "logo",       tag: "CGL TECH SOLUTIONS" },
  { id: 7,  type: "image", src: img7,  cat: "logo",       tag: "CGL TECH SOLUTIONS"    },
  { id: 8,  type: "image", src: img8,  cat: "logo",  tag: "CGL TECH SOLUTIONS"   },
  { id: 9,  type: "video", src: vid1,  cat: "video",     tag: "CGL TECH SOLUTIONS"      },
  { id: 10, type: "image", src: img9,  cat: "logo",  tag: "CGL TECH SOLUTIONS"   },
  { id: 11, type: "image", src: img10, cat: "logo",       tag: "CGL TECH SOLUTIONS"    },
  { id: 12, type: "image", src: img11, cat: "smm",       tag: "CGL TECH SOLUTIONS"     },
  { id: 13, type: "image", src: img12, cat: "seo",       tag: "CGL TECH SOLUTIONS"        },
  { id: 14, type: "image", src: img13, cat: "app",       tag: "CGL TECH SOLUTIONS"    },
  { id: 15, type: "video", src: vid2,  cat: "video",     tag: "CGL TECH SOLUTIONS"      },
  { id: 16, type: "image", src: img14, cat: "sem",       tag: "CGL TECH SOLUTIONS" },
  { id: 17, type: "image", src: img15, cat: "branding",  tag: "CGL TECH SOLUTIONS"   },
  { id: 18, type: "image", src: img16, cat: "logo",       tag: "CGL TECH SOLUTIONS"        },
  { id: 19, type: "image", src: img17, cat: "logo",       tag: "CGL TECH SOLUTIONS"    },
  { id: 20, type: "image", src: img18, cat: "logo",       tag: "CGL TECH SOLUTIONS"     },
  { id: 21, type: "image", src: img19, cat: "logo",        tag: "CGL TECH SOLUTIONS" },
  { id: 22, type: "image", src: img20, cat: "logo",  tag: "CGL TECH SOLUTIONS"   },
  { id: 23, type: "video", src: vid3,  cat: "video",     tag: "CGL TECH SOLUTIONS"      },
  { id: 24, type: "image", src: img21, cat: "logo",  tag: "CGL TECH SOLUTIONS"   },
  { id: 25, type: "image", src: img22, cat: "logo",       tag: "CGL TECH SOLUTIONS"    },
  { id: 26, type: "image", src: img23, cat: "logo",       tag: "CGL TECH SOLUTIONS"        },
  { id: 27, type: "image", src: img24, cat: "app",       tag: "CGL TECH SOLUTIONS"    },
  { id: 28, type: "image", src: img25, cat: "sem",       tag: "CGL TECH SOLUTIONS" },
  { id: 29, type: "image", src: img26, cat: "erp",       tag: "CGL TECH SOLUTIONS"        },
  { id: 30, type: "image", src: img27, cat: "smm",       tag: "CGL TECH SOLUTIONS"     },
  { id: 31, type: "image", src: img28, cat: "ai",        tag: "CGL TECH SOLUTIONS" },
  { id: 32, type: "video", src: vid4,  cat: "video",     tag: "CGL TECH SOLUTIONS"      },
  { id: 33, type: "image", src: img29, cat: "branding",  tag: "CGL TECH SOLUTIONS"   },
  { id: 34, type: "image", src: img30, cat: "web",       tag: "CGL TECH SOLUTIONS"    },
  { id: 35, type: "image", src: img31, cat: "whatsapp",  tag: "CGL TECH SOLUTIONS"   },
